...
const NAV_HEADER_BASE =
  "px-2.5 py-1 font-display text-xs font-semibold uppercase tracking-wide transition-colors duration-300";
...
export const ui = {
  ...
  wordmark: "font-display text-xl font-extrabold uppercase tracking-wide text-[var(--c-brand-text)]",
