  ...
  return (
    <div className="space-y-10">
      ...
      <section className="max-w-2xl">
        ...
        <p className="mt-3 text-neutral-700">{st(lang, "home_hero_sub")}</p>
        <div className="mt-5 flex flex-wrap gap-3">
          ...
          <Link
            href="/ranking"
            className="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium text-neutral-700 transition hover:border-brand hover:text-brand"
          >
      ...
      <section>
        ...
        {next ? (
          <Link
            href="/games"
            className="mt-3 block rounded-lg border border-neutral-200 bg-white p-5 transition hover:border-brand"
          >
            <div className="flex items-baseline justify-between gap-3">
              <span className="text-base font-semibold text-neutral-900">{next.title ?? "ASG"}</span>
              <span className="text-sm text-neutral-500">{countText}</span>
            </div>
          ...
          <p className="mt-3 rounded-lg border border-dashed border-neutral-300 p-5 text-sm text-neutral-500">
      ...
      <section className="max-w-2xl">
        ...
        <blockquote className="mt-3 border-l-4 border-brand/40 bg-white px-4 py-3 text-sm leading-relaxed text-neutral-700">
