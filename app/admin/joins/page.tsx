...
export default async function AdminJoins() {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-neutral-500">{st(lang, "adm_joins_note")}</p>
            ...
            <tbody>
              {rows.map((r) => (
                <tr key={r.id} className="border-b border-neutral-100 last:border-0">
                  <td className="px-3 py-2 tabular-nums text-neutral-700">{r.user_id}</td>
                  <td className="px-3 py-2 text-neutral-500">{r.lang}</td>
