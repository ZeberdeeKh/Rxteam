...
const SITE: Record<string, Dict> = {
  ...
  nav_carpool: { pl: "Carpool", en: "Carpool", uk: "Карпул" },
  ...
  // ── Карпул-мапа (Етап 34) ──
  carpool_title: { pl: "Carpool", en: "Carpool", uk: "Карпул" },
  carpool_map_for: { pl: "Carpool — «{title}»", en: "Carpool — «{title}»", uk: "Карпул — «{title}»" },
  carpool_intro: {
    pl: "Kierowcy oznaczają, skąd jadą — możesz poprosić o miejsce w aucie. Po akceptacji dostaniesz kontakt kierowcy.",
    en: "Drivers mark where they set off from — you can request a seat. Once accepted, you get the driver's contact.",
    uk: "Водії позначають, звідки виїжджають — можеш попросити місце в авто. Після підтвердження отримаєш контакт водія.",
  },
  carpool_no_game: { pl: "Brak nadchodzących gier.", en: "No upcoming games.", uk: "Немає найближчих ігор." },
  carpool_back_games: { pl: "← Gry", en: "← Games", uk: "← Ігри" },
  carpool_past: {
    pl: "Ta gra już się odbyła — rezerwacja miejsc jest zamknięta.",
    en: "This game is over — seat booking is closed.",
    uk: "Ця гра вже відбулась — бронювання закрите.",
  },
  carpool_drivers_heading: { pl: "Kierowcy", en: "Drivers", uk: "Водії" },
  carpool_no_drivers: {
    pl: "Nikt jeszcze nie oznaczył miejsca wyjazdu.",
    en: "No one has marked a departure point yet.",
    uk: "Поки ніхто не позначив точку виїзду.",
  },
  carpool_you: { pl: "(Ty)", en: "(You)", uk: "(Ти)" },
  ...
  carpool_cancel_request: { pl: "Anuluj", en: "Cancel", uk: "Скасувати" },
  ...
  carpool_pin_hint: {
    ...
    uk: "Клікни по мапі або тисни «моя GPS», щоб позначити, звідки їдеш. Постав орієнтир поруч, а не точну адресу дому.",
  },
  carpool_pin_set: {
    pl: "Twój punkt wyjazdu jest ustawiony. Kliknij mapę, aby go przenieść.",
    en: "Your departure point is set. Click the map to move it.",
    uk: "Твоя точка виїзду встановлена. Клікни по мапі, щоб перенести.",
  },
  carpool_use_location: { pl: "Moja lokalizacja", en: "My location", uk: "Моя локація" },
  carpool_locating: { pl: "Ustalanie…", en: "Locating…", uk: "Визначаю…" },
  carpool_geo_err: { pl: "Nie udało się ustalić lokalizacji.", en: "Couldn't get your location.", uk: "Не вдалося отримати локацію." },
  carpool_save_pin: { pl: "Zapisz punkt", en: "Save point", uk: "Зберегти точку" },
  carpool_ok_pin: { pl: "Zapisano punkt wyjazdu.", en: "Departure point saved.", uk: "Точку виїзду збережено." },
  carpool_ok_req: { pl: "Wysłano prośbę do kierowcy.", en: "Request sent to the driver.", uk: "Запит надіслано водієві." },
  carpool_ok_cancel: { pl: "Anulowano prośbę.", en: "Request cancelled.", uk: "Запит скасовано." },
  carpool_ok_accepted: { pl: "Przyjęto prośbę.", en: "Request accepted.", uk: "Запит прийнято." },
  carpool_ok_declined: { pl: "Odrzucono prośbę.", en: "Request declined.", uk: "Запит відхилено." },
  carpool_err_geo: { pl: "Nieprawidłowa lokalizacja.", en: "Invalid location.", uk: "Хибна локація." },
  carpool_err_not_driver: {
    pl: "Tylko kierowcy (zapis „własnym autem”) mogą ustawić punkt.",
    en: "Only drivers (signed up as „own ride”) can set a point.",
    uk: "Точку може ставити лише водій (запис «своїм ходом»).",
  },
  carpool_err_self: { pl: "To Twoje auto 🙂", en: "That's your own car 🙂", uk: "Це твоя машина 🙂" },
  carpool_err_duplicate: { pl: "Już poprosiłeś tego kierowcę.", en: "You already asked this driver.", uk: "Ти вже просив цього водія." },
  carpool_err_closed: { pl: "Kierowca zamknął nabór.", en: "The driver closed seats.", uk: "Водій закрив набір." },
  carpool_err_full: { pl: "Brak wolnych miejsc.", en: "No free seats left.", uk: "Вільних місць немає." },
  carpool_err_game_past: { pl: "Rezerwacja na tę grę jest zamknięta.", en: "Booking for this game is closed.", uk: "Бронювання на цю гру закрите." },
  carpool_err_driver_not_found: { pl: "Nie znaleziono kierowcy.", en: "Driver not found.", uk: "Водія не знайдено." },
  carpool_err_forbidden: { pl: "Brak uprawnień.", en: "Not allowed.", uk: "Немає прав." },
  ...
  faq_intro: {
    pl: "Zasady społeczności RX Team oraz wątków naszej grupy na Telegramie. To samo zobaczysz w bocie pod komendą /rules.",
    en: "RX Team community rules and the rules of our Telegram group topics. The same is available in the bot under /rules.",
    uk: "Правила спільноти RX Team та гілок нашої групи в Telegram. Те саме доступне в боті за командою /rules.",
  },
  faq_footnote: {
    pl: "Zasady mogą się zmieniać. Aktualna wersja jest zawsze w bocie pod komendą /rules.",
    en: "Rules may change. The current version is always in the bot under /rules.",
  ...
  prof_no_rank: { pl: "brak (potrzebna naszywka)", en: "none (patch needed)", uk: "немає (потрібен патч)" },

  // Патч у кабінеті (запит на нашивку)
  prof_patch: { pl: "Naszywka", en: "Patch", uk: "Патч" },
  // Наявність патча показуємо як «Отримано <дата>» (дата — окремим faint-спаном у кабінеті).
  patch_received: { pl: "✅ Otrzymano", en: "✅ Received", uk: "✅ Отримано" },
  patch_no_site: { pl: "❌ brak", en: "❌ no", uk: "❌ немає" },
  patch_request_btn: { pl: "Złóż prośbę o naszywkę", en: "Request patch", uk: "Подати запит на патч" },
  patch_under_review: {
  ...
  patch_approved_site: {
    pl: "✅ Zatwierdzono — odbierzesz naszywkę na najbliższej grze.",
  ...
  patch_drawer_title: { pl: "Prośba o naszywkę", en: "Patch request", uk: "Запит на патч" },
  patch_benefits_site: {
  ...
  err_patch_pending: {
    pl: "Masz już otwartą prośbę o naszywkę.",
    en: "You already have an open patch request.",
    uk: "У тебе вже є відкритий запит на патч.",
  },
  err_patch_has: { pl: "Masz już naszywkę.", en: "You already have the patch.", uk: "У тебе вже є патч." },
  err_patch_off: {
    pl: "Funkcja naszywki jest wyłączona.",
  ...
  shop_ranks_intro: {
    pl: "Kupuj kolejne rangi za punkty. Wymagana naszywka; rangi zdobywasz po kolei.",
  ...
  shop_rank_need_patch: {
    pl: "Rangi są dostępne po odebraniu naszywki (członkostwo).",
  ...
  shop_err_rank_need_patch: {
    pl: "Najpierw odbierz naszywkę, aby kupować rangi.",
  ...
  adm_nav_patch: { pl: "Naszywki", en: "Patches", uk: "Патчі" },
  ...
  adm_btn_patch: { pl: "Naszywka ↔", en: "Patch ↔", uk: "Patch ↔" },
  adm_btn_patch_give: { pl: "Wydaj naszywkę", en: "Give patch", uk: "Видати патч" },
  adm_btn_patch_take: { pl: "Zabierz naszywkę", en: "Take patch", uk: "Забрати патч" },
  ...
  adm_perm_players: {
    pl: "korekta punktów/salda, naszywka, zmiana pseudonimu, przyznawanie osiągnięć.",
  ...
  adm_perm_patch: {
    pl: "zarządzanie prośbami o naszywkę (zatwierdzanie, wydanie na grze) i ustawieniami systemu naszywek.",
  ...
  adm_patch_requests_title: { pl: "Prośby o naszywkę", en: "Patch requests", uk: "Заявки на патч" },
  adm_patch_no_requests: { pl: "Brak aktywnych próśb.", en: "No active requests.", uk: "Немає активних заявок." },
  adm_patch_settings_title: { pl: "Ustawienia systemu naszywek", en: "Patch system settings", uk: "Налаштування системи патчів" },
